...
public class SearchViewEmp implements Initializable {
    ...
    public void byId(ActionEvent event) {
    ...
    public void byAadhaar(ActionEvent event) {
        try {
            String fetchSql = "SELECT * FROM employeerec WHERE Aadhaar=?";
            ps = connection.prepareStatement(fetchSql);
